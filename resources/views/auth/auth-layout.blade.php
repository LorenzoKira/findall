        ...
        <div class="auth-layout-container">
            <div class="form-container">
                ...
                <div class="auth-layout-login-buttons">
                    <a href="#">
                        <x-button class="action-btn auth-btn hover:bg-hover">
